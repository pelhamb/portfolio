...
I also like to work music into my engineering projects. See "MIDI Synth on RP2040" on [this page](docs/micro.html) in my [Projects](docs/projects.html) section.
